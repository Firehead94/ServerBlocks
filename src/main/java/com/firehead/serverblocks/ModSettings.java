...
public class ModSettings {
	...
	public static final int TIER_1_LENGTH_DEFAULT = 10;
	public static final int TIER_1_HEIGHT_DEFAULT = 15;
	
	public static final String TIER_2_NAME_DEFAULT = "Stone";
	public static final int TIER_2_WIDTH_DEFAULT = 20;
	public static final int TIER_2_LENGTH_DEFAULT = 20;
	public static final int TIER_2_HEIGHT_DEFAULT = 15;
	
	public static final String TIER_3_NAME_DEFAULT = "Iron";
	public static final int TIER_3_WIDTH_DEFAULT = 30;
	public static final int TIER_3_LENGTH_DEFAULT = 30;
	public static final int TIER_3_HEIGHT_DEFAULT = 15;
	
	public static final String TIER_4_NAME_DEFAULT = "Gold";
	public static final int TIER_4_WIDTH_DEFAULT = 40;
	public static final int TIER_4_LENGTH_DEFAULT = 40;
	public static final int TIER_4_HEIGHT_DEFAULT = 15;
	
	public static final String TIER_5_NAME_DEFAULT = "Emerald";
	public static final int TIER_5_WIDTH_DEFAULT = 50;
	public static final int TIER_5_LENGTH_DEFAULT = 50;
	public static final int TIER_5_HEIGHT_DEFAULT = 15;
	
	public static final String TIER_6_NAME_DEFAULT = "Diamond";
	public static final int TIER_6_WIDTH_DEFAULT = 60;
